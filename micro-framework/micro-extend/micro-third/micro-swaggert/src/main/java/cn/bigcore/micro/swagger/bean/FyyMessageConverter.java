...
public class FyyMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
    ...
    private boolean supportInternalAndHandle(Class<?> clazz) {
        boolean securityBody = ClassUtil.isAssignable(FyyOutputParamAbstract.class, clazz);
        return securityBody;
    }
//
//    @Override
