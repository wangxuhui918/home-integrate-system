...
//        parameters.add(p1);
        ...
        Docket doc = new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                ...
                .apis(RequestHandlerSelectors.basePackage(FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_SWAGGER_BASEPACKAGE.getKey())))
                //paths() 过滤什么路径
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfo(FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_SWAGGER_NAME.getKey()), "你要快快长大哦", "1.0", "urn:tos", contact,
