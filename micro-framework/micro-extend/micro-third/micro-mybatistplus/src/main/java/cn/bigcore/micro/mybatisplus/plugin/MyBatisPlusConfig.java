...
import cn.bigcore.micro.mybatisplus.starter.mybatis.config.MapperConfiguration;
import cn.hutool.setting.Setting;
import cn.bigcore.micro.core.configration.annotation.RuleInjection;
import cn.bigcore.micro.mybatisplus.starter.mybatis.config.MybatisPlusAutoConfiguration;
...
//            }
//        }
        if (BaseEv.SettingInformation.setting.getBool(ConfigDetails.MYBATISPLUS_ENABLE.getKey())) {
            return Arrays.asList(new Class[]{MapperConfiguration.class, MybatisPlusAutoConfiguration.class});
        }
