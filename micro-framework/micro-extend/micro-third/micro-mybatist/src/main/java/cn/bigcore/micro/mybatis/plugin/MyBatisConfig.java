...
import cn.bigcore.micro.mybatis.automethod.MybatisAutoMethod;
import cn.bigcore.micro.mybatis.starter.mybatis.config.MapperConfiguration;
import cn.bigcore.micro.mybatis.starter.mybatis.config.TkMybatisAutoConfiguration;
...
//            }
//        }
        if (BaseEv.SettingInformation.setting.getBool(ConfigDetails.MYBATIS_ENABLE.getKey())) {
            return Arrays.asList(new Class[]{MapperConfiguration.class, TkMybatisAutoConfiguration.class, MybatisAutoMethod.class});
        }
