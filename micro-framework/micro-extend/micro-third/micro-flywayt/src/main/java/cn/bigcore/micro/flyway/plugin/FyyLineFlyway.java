...
//            return new ArrayList<>();
//        }
        if (FyyInitEnv.ProjectInformation.setting.getBool(FyyConfigEntryDetailsValues.FLYWAYDB_ENABLE.getKey())) {
    ...
    public void callSetting(Setting setting) {
        {
            ...
            if (!setting.containsKey(key)) {
                if (FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_DB_URL.getKey()) != null)
        ...
        }
        {
            ...
            if (!setting.containsKey(key)) {
                if (FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_DB_USERNAME.getKey()) != null)
                    setting.put(key, (FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_DB_USERNAME.getKey())));
            }
        }
        {
            String key = FyyConfigEntryDetailsValues.HOME_FLYWAYDB_PASSWORD.getKey();
            if (!setting.containsKey(key)) {
                if (FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_DB_PASSWORD.getKey()) != null)
                    setting.put(key, (FyyInitEnv.ProjectInformation.setting.get(FyyConfigEntryDetailsValues.HOME_DB_PASSWORD.getKey())));
            }
        }
