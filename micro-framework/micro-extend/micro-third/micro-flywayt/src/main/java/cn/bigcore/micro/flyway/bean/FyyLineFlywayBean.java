...
//        System.setProperty("spring.flyway.validate-on-migrate", "false");
        String dbUrl = FyyInitEnv.setting.get(FyyConfigEntryDetailsValues.HOME_FLYWAYDB_URL.getKey());
        String dbUserName = FyyInitEnv.setting.get(FyyConfigEntryDetailsValues.HOME_FLYWAYDB_USERNAME.getKey());
        String dbPassword = FyyInitEnv.setting.get(FyyConfigEntryDetailsValues.HOME_FLYWAYDB_PASSWORD.getKey());
        String table = FyyInitEnv.setting.get(FyyConfigEntryDetailsValues.HOME_FLYWAYDB_TABLE.getKey());
