...
import cn.bigcore.micro.gittools.vo.GitLabTag;
...
public class GitUtilsV2 {
     ...
     */
    @Deprecated
    public GitUtilsV2(String gitDir, String username, String password, String codeHttpUrl, String code, String token, String gitlabUrl) {
