...
import cn.bigcore.micro.log.FyyLoggerInterface;
 ...
 * 日志
 */
public class FyyLoggerUtil extends FyyLoggerInterface {

    private final Class<?> clazz;

    public FyyLoggerUtil(Class<?> clazz) {
        this.clazz = clazz;
    }
