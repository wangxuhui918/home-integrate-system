...
public class FyyConfigFrameUtils {
    ...
    public static <T> List<T> getPlugins(Class<T> a) {
        List<String> plugins = FyyInitEnv.homeConf.getPlugins(a);
