...
public enum ConfigDetails {
    ...
    //
    //
    SYSTEM_INPUTPARAMAB_CLASS(ConfigMain.SYSTEMCONFIG, "system.inputparamab.class", "=", "cn.bigcore.micro.outgoing.InputParamRe", ConfigInitValue.suffp + " 默认入参处理函数", ConfigInitValue.suffp),//
    //
    //
    //
