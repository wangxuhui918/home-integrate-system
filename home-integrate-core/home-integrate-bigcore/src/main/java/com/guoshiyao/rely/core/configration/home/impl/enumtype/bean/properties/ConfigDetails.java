...
public enum ConfigDetails {
    ...
    HOME_DUBBO_REFERENCE_URL(ConfigMain.DUBBO, 30, "home.dubbo.reference.url", "=", "zookeeper://zookeeper.com:2181", "# dubbo注册中心地址", "#"),//
    HOME_DUBBO_REFERENCE_AGREEMENT(ConfigMain.DUBBO, 31, "home.dubbo.reference.agreement", "=", "dubbo", "# dubbo协议", "#"),//
    HOME_DUBBO_REFERENCE_HOST(ConfigMain.DUBBO, 32, "home.dubbo.reference.host", "=", "127.0.0.1", "# dubbo本地地址", "#"),//
    ...
    HOME_MINIO_ENDPOINT(ConfigMain.MINIO, 39, "home.minio.endpoint", "=", "http://localhost:9000", "# api 请求地址 必填", "#"),//
    HOME_MINIO_ACCESSKEY(ConfigMain.MINIO, 40, "home.minio.accesskey", "=", "SDS*DSJDlerw9(were)", "# api 请求用户名", "#"),//
    HOME_MINIO_SECRETKEY(ConfigMain.MINIO, 41, "home.minio.secretKey", "=", "SDS*DSJDlerdsfsdf", "# api 请求密钥", "#"),//
    ...
    HOME_DB_URL(ConfigMain.DB, 46, "home.db.url", "=", "jdbc:mysql://localhost:3306/home?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=UTF-8", "# 数据库连接地址", "#"),//
    HOME_DB_USERNAME(ConfigMain.DB, 47, "home.db.username", "=", "root", "# 用户名", "#"),//
    HOME_DB_PASSWORD(ConfigMain.DB, 48, "home.db.password", "=", "password", "# 密码", "#"),//
    HOME_DB_DRIVERCLASSNAME(ConfigMain.DB, 49, "home.db.driverclassname", "=", "com.mysql.cj.jdbc.Driver", "# 驱动UrlClass", "#"),//
    HOME_DB_DRIVERCLASS_DOWNLOADURL(ConfigMain.DB, 50, "home.db.driverclass.downloadurl", "=", "https://repo1.maven.org/maven2/mysql/mysql-connector-java/5.1.49/mysql-connector-java-5.1.49.jar", "#驱动下载地址,使用 url 后可以不填写home.db.driverclassname,MAVEN POM 中无需加载驱动坐标,优先级低于home.db.driverclassname", "#"),//
    HOME_DB_VALIDATIONQUERY(ConfigMain.DB, 51, "home.db.validationquery", "=", "select 'x'", "# 数据库校验sql", "#"),//
    ...
    HOME_APOLLO_URL(ConfigMain.APOLLO, 71, "home.apollo.url", "=", "阿波罗管理地址,如果不填写则阿波罗不加载", "# 管理端", "#"),//
    HOME_APOLLO_USERNAME(ConfigMain.APOLLO, 72, "home.apollo.username", "=", "阿波罗管理用户名", "", "#"),//
    HOME_APOLLO_PASSWORD(ConfigMain.APOLLO, 73, "home.apollo.password", "=", "阿波罗管理密码", "", "#"),//
    HOME_APOLLO_APP_ID(ConfigMain.APOLLO, 74, "home.apollo.app.id", "=", "${idKey}", "# 客户端", "#"),//
    HOME_APOLLO_APOLLO_META(ConfigMain.APOLLO, 75, "home.apollo.apollo.meta", "=", "http://106.54.227.205:8080", "# 地址后缀不允许以/结尾", "#"),//
